...
<html>
<head>
	<title>Security Guards || Checkout System</title>
	<meta charset="utf-8">
	...
	<div class="contianer"><!--Page Wrapper-->
		...
		<div class="container" style="margin-top:125px;"><!--Page Contents-->			
			<div><!--Section left-->
				...
				<h4 class="text-center" style="color:whitesmoke; background-color:grey;"><b>SECURITY GUARDS</b></h4><br>

					<?php
						$query_table = mysqli_query($conn,"SELECT * FROM asset_tracker.security_guard ORDER BY Name");
				...
				?>
						...
						?>
								...
								if(isset($_POST['del']))
							{
								...
								$query_table = mysqli_query($conn,"DELETE FROM asset_tracker.security_guard WHERE id='$id'");
								if($query_table)
								{
									echo "<script>alert('Item Deleted Successfully!');</script>";
									echo "<script>window.location.href='view_security_guards.php';</script>";
								}
							}
